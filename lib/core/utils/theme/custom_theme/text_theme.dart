...
class AppTextTheme {
  ...
  //  displaySmall: GoogleFonts.poppins(fontSize: 24.0, fontWeight: FontWeight.normal, color: AppColors.dark),
    headlineLarge: GoogleFonts.poppins(fontSize: 22.0, fontWeight: FontWeight.bold, color: AppColors.headlineTextColor),
    headlineMedium: GoogleFonts.poppins(fontSize: 17.0, fontWeight: FontWeight.w500, color: AppColors.subtitleTextColor),

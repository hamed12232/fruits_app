...
class AppTextTheme {
  ...
  static TextTheme lightTextTheme = TextTheme(
    displayLarge: GoogleFonts.notoSans(fontSize: AppSizes.sp28, fontWeight: FontWeight.bold, color: AppColors.black),
  ...
  //  displaySmall: GoogleFonts.poppins(fontSize: 24.0, fontWeight: FontWeight.normal, color: AppColors.dark),
    headlineLarge: GoogleFonts.poppins(fontSize: AppSizes.sp22, fontWeight: FontWeight.bold, color: AppColors.headlineTextColor),
    headlineMedium: GoogleFonts.poppins(fontSize: AppSizes.sp17, fontWeight: FontWeight.w500, color: AppColors.subtitleTextColor),
  ...
  //  bodyLarge: GoogleFonts.poppins(fontSize: 14.0, color: AppColors.bodyTextColor),
    bodyMedium: GoogleFonts.poppins(fontSize: AppSizes.sp18, color: AppColors.black, fontWeight: FontWeight.w400),
    labelMedium: GoogleFonts.titilliumWeb(fontSize: AppSizes.sp19, color: AppColors.black, fontWeight: FontWeight.bold),
  );
